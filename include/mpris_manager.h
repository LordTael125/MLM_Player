...
public slots:
    ...
    void setMetadata(const QString &id, const QString &title, const QString &artist, 
...
public:
    ...
    qlonglong Position() const { return static_cast<qlonglong>(m_manager->m_positionSeconds) * 1000000LL; }
...
public slots:
    ...
    void Seek(qlonglong Offset) { emit m_manager->seekRequested(m_manager->m_positionSeconds + Offset / 1000000LL); }
    void SetPosition(const QDBusObjectPath &, qlonglong Position) { emit m_manager->seekRequested(Position / 1000000LL); }
